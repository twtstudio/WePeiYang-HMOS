...
import 'package:wepei_module/commons/util/level_util.dart';
...
import 'package:wepei_module/feedback/view/components/widget/clip_copy.dart';
...
import 'package:wepei_module/feedback/view/image_view/image_view_page.dart';
import 'package:wepei_module/feedback/view/reply_detail_page.dart';
                  ...
                  actions: <Widget>[
                    if (hasAdmin)
                      CupertinoActionSheetAction(
                        ...
                        child: Text(
                          "恢复原评论状态（取消置顶）",
                          style: TextUtil.base.normal.w400.ProductSans
                              .primary(context)
                              .sp(16),
                        ),
                      ),
                    ...
                    // 拉黑按钮
                    if ((Platform.isIOS || (!Platform.isAndroid && !Platform.isIOS)) && widget.showBlockButton)
                      // 分享按钮
                      CupertinoActionSheetAction(
                        onPressed: () {
            ...
            children: [
              ConstrainedBox(
                ...
                child: Text(
                  ...
                  style:
                      TextUtil.base.w400.bold.ProductSans.sp(16).label(context),
                ),
              ),
              Padding(
                  ...
                  children: [
                    ...
                    ConstrainedBox(
                      ...
                      child: Text(
                        ...
                        style:
                            TextUtil.base.w700.ProductSans.sp(16).label(context),
                      ),
                    ),
                    SizedBox(width: 2)
                  ],
              ...
              if (widget.comment.value != 0)
                Text(
                  "  置顶评论",
                  style: TextUtil.base.w500.ProductSans
                      .sp(10)
          ...
          child: CommentCardGestureDetector(
            ...
            child: Builder(builder: (context) {
              return ExpandableText(
                ...
                style:
                    TextUtil.base.w400.ProductSans.label(context).h(1.8).sp(14),
      ...
      child: Column(
          ...
          children: [
            ...
            Center(
                child: Text("评论置顶",
                    style:
                        TextUtil.base.ProductSans.w500.sp(16).label(context))),
            SizedBox(
            ...
            Center(
              child: ElevatedButton(
                ...
                child: Text("确认",
                    style: TextUtil.base.ProductSans.w500.sp(14).label(context)),
              ),
            )
          ]),
    ));
