...
import 'package:wepei_module/feedback/view/components/widget/search_bar.dart'
    as wpySearchBar;
            ...
            return InkResponse(
              ...
              child: Chip(
                ...
                label: Text(list[list.length - index - 1],
                    style:
                        TextUtil.base.normal.label(context).PingFangSC.sp(16)),
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return LakeDialogWidget(
              ...
              titleTextStyle:
                  TextUtil.base.normal.label(context).PingFangSC.sp(18).w600,
              cancelText: '取消',
              confirmTextStyle:
                  TextUtil.base.normal.reverse(context).PingFangSC.sp(16).w400,
              cancelTextStyle:
