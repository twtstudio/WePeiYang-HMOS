...
import 'package:wepei_module/auth/view/info/avatar_box_page.dart';
import 'package:wepei_module/auth/view/info/avatar_crop_page.dart';
import 'package:wepei_module/auth/view/info/email_bind_page.dart';
import 'package:wepei_module/auth/view/info/phone_bind_page.dart';
import 'package:wepei_module/auth/view/info/reset_nickname_page.dart';
import 'package:wepei_module/auth/view/info/reset_password_page.dart';
import 'package:wepei_module/auth/view/info/tju_bind_page.dart';
import 'package:wepei_module/auth/view/info/user_info_page.dart';
import 'package:wepei_module/auth/view/login/add_info_page.dart';
import 'package:wepei_module/auth/view/login/find_pw_page.dart';
import 'package:wepei_module/auth/view/login/login_page.dart';
import 'package:wepei_module/auth/view/login/login_pw_page.dart';
import 'package:wepei_module/auth/view/login/register_page.dart';
import 'package:wepei_module/auth/view/login/reset_done_page.dart';
import 'package:wepei_module/auth/view/login/reset_pw_page.dart';
import 'package:wepei_module/auth/view/settings/general_setting_page.dart';
import 'package:wepei_module/auth/view/settings/schedule_setting_page.dart';
import 'package:wepei_module/auth/view/settings/setting_page.dart';
import 'package:wepei_module/auth/view/settings/shield_setting_page.dart';
import 'package:wepei_module/auth/view/settings/toolbar_manage_page.dart';
import 'package:wepei_module/auth/view/user/about_twt_page.dart';
import 'package:wepei_module/auth/view/user/debug_page.dart';
