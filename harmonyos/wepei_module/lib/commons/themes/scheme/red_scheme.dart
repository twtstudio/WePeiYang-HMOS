...
import 'package:wepei_module/commons/themes/scheme/light_scheme.dart';
import 'package:wepei_module/commons/themes/template/official_meta_data.dart';
  ...
  RedScheme()
      : super(
          ...
          data: WpyThemeDetail(
            ...
            primaryColor: redMapper(redPrimaryColor),
          ),
        );
}

const redPrimaryColor = Color(0xFFFF0000);

ColorMapper redMapper = (Color source) {
  HSLColor hsl = HSLColor.fromColor(source);
  HSLColor targetHsl = HSLColor.fromColor(redPrimaryColor);
  return hsl
      .withHue(targetHsl.hue)
      .withLightness((hsl.lightness - 0.1).clamp(0, 1))
      .withSaturation((hsl.saturation - 0.2).clamp(0, 1))
      .toColor();
};

final Map<WpyColorKey, dynamic> redSchemeDetail = {
  WpyColorKey.defaultActionColor: redMapper,
  ...
  WpyColorKey.cursorColor: redMapper,
  ...
  WpyColorKey.primaryActionColor: redMapper,
  WpyColorKey.primaryLightActionColor: redMapper,
  WpyColorKey.primaryTextButtonColor: redMapper,

  // the Main Action on main page
  WpyColorKey.beanDarkColor: redMapper,
  WpyColorKey.beanLightColor: redMapper,

  WpyColorKey.lightPrimaryContainer: redMapper,
  WpyColorKey.lighterPrimaryBackGround: redMapper,

// schedule page background color
  WpyColorKey.primaryLighterActionColor: redMapper,
  WpyColorKey.primaryLightestActionColor: redMapper,
...
// bind classes pages
  WpyColorKey.oldActionColor: redMapper,
  WpyColorKey.oldSecondaryActionColor: redMapper,
  WpyColorKey.oldThirdActionColor: redMapper,
  WpyColorKey.oldFurthActionColor: redMapper,
  WpyColorKey.oldActionRippleColor: redMapper,
...
//三个加载的点点
  ...
  WpyColorKey.loadPointA: redMapper,
  WpyColorKey.loadPointB: redMapper,
  WpyColorKey.loadPointC: redMapper,

//Avatar chosen pink
  WpyColorKey.avatarChosenColor: Color(0xFFFFCCD1),

// 地图 校历 页面的蒙版
  WpyColorKey.beiyangCampusMaskColor: redMapper,
  WpyColorKey.unSelectedIcon: redMapper,
  WpyColorKey.backgroundMaskColor: redMapper,
...
// gradient
  ...
  WpyColorSetKey.primaryGradient: LinearGradient(
    colors: [
      redMapper(lightSchemeDetail[WpyColorKey.primaryActionColor]!),
      redMapper(lightSchemeDetail[WpyColorKey.primaryLightActionColor]!),
// 用来挡下面圆角左右的空
