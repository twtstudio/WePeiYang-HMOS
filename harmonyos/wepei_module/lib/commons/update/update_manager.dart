...
import 'package:wepei_module/commons/channel/install/hotfix.dart';
import 'package:wepei_module/commons/channel/install/install.dart';
import 'package:wepei_module/commons/channel/local_setting/local_setting.dart';
...
class UpdateManager extends UpdateStatusListener {
  ...
  dynamic get version => Platform.isAndroid ? _androidVersion : Platform.isIOS ? _iosVersion : null;
  ...
  Future<void> checkUpdate({bool auto = true}) async {
    switch (status) {
      case UpdateStatus.idle:
        ...
        // On HarmonyOS (OpenHarmony), skip update checking gracefully
